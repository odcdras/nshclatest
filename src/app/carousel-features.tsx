  ...
  return (
    <section className="px-8 pt-40 pb-20">
      <div className="flex mb-16 flex-col items-center">
        <Typography variant="h2" className="text-center mb-2" color="black">
          Our Events
        </Typography>
        <Typography
          variant="lead"
          ...
          {new Array(2).fill("").map((_, i) => (
            ...
            >
              <div className="col-span-3 flex flex-col items-start justify-center">
                ...
                >
                  Thank you to all our sponsors and exhibitors for helping to make this event a success!                 
